...
-   Install `lintr` in R Studio and try re-formatting your code following the [Tidyverse R style guide](https://style.tidyverse.org/).
-   You're welcome to reformat one of my scripts [here](https://github.com/ccbs-stradl/coding_club_linting/tree/main/exercise/) instead of your own code if you like.
-   **Advanced:** Set up GitHub actions to automate linting.

## [https://github.com/ccbs-stradl/coding_club_linting](https://github.com/ccbs-stradl/coding_club_linting)
